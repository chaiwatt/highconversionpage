        ...
        <div class="row">
            <div class="col-md-8 col-md-offset-2 text-center">
                <div class="guaranted-box">
                    ...
                    <p>น้องโปรแกรม ณัฐพัชร์ ทวีจันทร์ <br>โรงเรียนปรินส์รอยแยลวิทยาลัย</p>
                    
                    {{-- <p><img src="{{asset('assets/salepage/images/sign.png')}}" alt="" /></p> --}}
                    <p><img src="{{asset('assets/salepage/images/man.png')}}" class="img-circle" alt="" /></p>
                </div>
            </div>
        </div>
    </div>
